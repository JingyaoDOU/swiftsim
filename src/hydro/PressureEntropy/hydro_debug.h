...
__attribute__((always_inline)) INLINE static void hydro_debug_particle(
  ...
  warning(
      "[PID%lld] x=[%.3e,%.3e,%.3e], "
      "v=[%.3e,%.3e,%.3e],v_full=[%.3e,%.3e,%.3e], a=[%.3e,%.3e,%.3e], "
      ...
      xp->v_full[0], xp->v_full[1], xp->v_full[2], p->a_hydro[0], p->a_hydro[1],
      p->a_hydro[2], p->h, p->density.wcount, p->density.wcount_dh, p->mass,
      p->density.rho_dh, p->rho, p->rho_bar, hydro_get_comoving_pressure(p),
